...
export default {
  ...
  mounted: function () {
    ...
    axios
      .get(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/3745 N Lincoln Ave, Chicago, IL 60613.json?access_token=pk.eyJ1Ijoia2F0ZXZhbnNkZXYiLCJhIjoiY2wxcGszanVtMThqczNkdGNiOXJsNmViYiJ9.Dzviryeelie_bodosYl9_g`
      )
